...
var SceneA = new Phaser.Class({
    ...
    create: function ()
    {
        ...
        //Aidé par Laure
        let temp = this;
        // for(var i=0; i<liste_plateformes.length;i++) {
        //     if(Math.random()<=2/3) {
        //         var mob = this.physics.add.sprite(liste_plateformes[i].x, 50, 'cerf');
        //         mobs.add(mob);
        ...
        // for(var i=600; i<4000; i+=800) {
        //     var mob = this.physics.add.sprite(i, 440, 'cerf');
        //     mobs.add(mob);
        //     mob.depart=i;
        //     mob.limite = 250;
        //     mob.setCollideWorldBounds(true); //rebond sur les bords du monde
...
//     preload: function ()
//     {
//         this.load.image('overlay', 'assets/backgroundb.jpg');
...
//         //  A simple background for our game avec mise à l'échelle pour le 1600x600
//         this.add.image(4000, 285, 'overlay').setScale(1.07,1);
...
//     preload: function ()
//     {
//         this.load.image('mech', 'assets/titre.png');
//     },
